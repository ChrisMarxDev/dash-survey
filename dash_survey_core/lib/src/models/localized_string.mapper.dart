...
class LocalizedTextListMapper extends ClassMapperBase<LocalizedTextList> {
  LocalizedTextListMapper._();

  static LocalizedTextListMapper? _instance;
  static LocalizedTextListMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(_instance = LocalizedTextListMapper._());
    }
    return _instance!;
  }

  @override
  final String id = 'LocalizedTextList';

  static Map<LocaleCode, List<String>> _$data(LocalizedTextList v) => v.data;
  static const Field<LocalizedTextList, Map<LocaleCode, List<String>>> _f$data =
      Field('data', _$data);

  @override
  final MappableFields<LocalizedTextList> fields = const {
    #data: _f$data,
  };

  static LocalizedTextList _instantiate(DecodingData data) {
    return LocalizedTextList(data.dec(_f$data));
  }

  @override
  final Function instantiate = _instantiate;

  static LocalizedTextList fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<LocalizedTextList>(map);
  }

  static LocalizedTextList fromJson(String json) {
    return ensureInitialized().decodeJson<LocalizedTextList>(json);
  }
}

mixin LocalizedTextListMappable {
  String toJson() {
    return LocalizedTextListMapper.ensureInitialized()
        .encodeJson<LocalizedTextList>(this as LocalizedTextList);
  }

  Map<String, dynamic> toMap() {
    return LocalizedTextListMapper.ensureInitialized()
        .encodeMap<LocalizedTextList>(this as LocalizedTextList);
  }

  LocalizedTextListCopyWith<LocalizedTextList, LocalizedTextList,
          LocalizedTextList>
      get copyWith => _LocalizedTextListCopyWithImpl(
          this as LocalizedTextList, $identity, $identity);
  @override
  String toString() {
    return LocalizedTextListMapper.ensureInitialized()
        .stringifyValue(this as LocalizedTextList);
  }

  @override
  bool operator ==(Object other) {
    return LocalizedTextListMapper.ensureInitialized()
        .equalsValue(this as LocalizedTextList, other);
  }

  @override
  int get hashCode {
    return LocalizedTextListMapper.ensureInitialized()
        .hashValue(this as LocalizedTextList);
  }
}

extension LocalizedTextListValueCopy<$R, $Out>
    on ObjectCopyWith<$R, LocalizedTextList, $Out> {
  LocalizedTextListCopyWith<$R, LocalizedTextList, $Out>
      get $asLocalizedTextList =>
          $base.as((v, t, t2) => _LocalizedTextListCopyWithImpl(v, t, t2));
}

abstract class LocalizedTextListCopyWith<$R, $In extends LocalizedTextList,
    $Out> implements ClassCopyWith<$R, $In, $Out> {
  MapCopyWith<$R, LocaleCode, List<String>,
      ObjectCopyWith<$R, List<String>, List<String>>> get data;
  $R call({Map<LocaleCode, List<String>>? data});
  LocalizedTextListCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(
      Then<$Out2, $R2> t);
}

class _LocalizedTextListCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, LocalizedTextList, $Out>
    implements LocalizedTextListCopyWith<$R, LocalizedTextList, $Out> {
  _LocalizedTextListCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<LocalizedTextList> $mapper =
      LocalizedTextListMapper.ensureInitialized();
  @override
  MapCopyWith<$R, LocaleCode, List<String>,
  ...
  $R call({Map<LocaleCode, List<String>>? data}) =>
      $apply(FieldCopyWithData({if (data != null) #data: data}));
  @override
  LocalizedTextList $make(CopyWithData data) =>
      LocalizedTextList(data.get(#data, or: $value.data));

  @override
  LocalizedTextListCopyWith<$R2, LocalizedTextList, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
      _LocalizedTextListCopyWithImpl($value, $cast, t);
}
